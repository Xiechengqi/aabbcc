...
lotus_move_storage_spend_time_minute=`echo ${lotus_move_storage_spend_time} | awk -F 'm' '{print $1}'`
lotus_move_storage_spend_time_second=`echo ${lotus_move_storage_spend_time} | awk -F 'm' '{print $NF}'`
...
# HELP lotus_move_storage_time get lotus move storage spend time
# TYPE lotus_move_storage_time gauge
